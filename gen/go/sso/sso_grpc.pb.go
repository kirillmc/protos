...
type AuthClient interface {
	...
	Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginsResponse, error)
...
func (c *authClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginsResponse, error) {
	out := new(LoginsResponse)
...
type AuthServer interface {
	...
	Login(context.Context, *LoginRequest) (*LoginsResponse, error)
...
func (UnimplementedAuthServer) Login(context.Context, *LoginRequest) (*LoginsResponse, error) {
